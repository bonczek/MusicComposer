...
public class ConverterTest {
    ...
    public void testNotesToChromosomeConversion() throws Exception {
        Note[] notes = {new Sound(Pitch.A, Octave.CONTRA, Durations.SIXTEENTH_NOTE), new Rest(Durations.HALF_NOTE),
                new Sound(Pitch.D, Octave.FOUR_LINED, Durations.QUARTER_NOTE), new Rest(Durations.DOTTED_EIGHTH_NOTE)};
    ...
    public void testInvalidNotesConversion() throws Exception {
        Note[] notes = {new Sound(Pitch.A, Octave.CONTRA, Durations.QUARTER_NOTE), new Rest(-2.0)};
        List<Note> noteList = Arrays.asList(notes);
    ...
    public void testTooManyNotesConversion() throws Exception {
        Note[] notes = {new Sound(Pitch.A, Octave.CONTRA, Durations.WHOLE_NOTE), new Rest(Durations.QUARTER_NOTE)};
        List<Note> noteList = Arrays.asList(notes);
