...
public class MusicalStatisticsFitnessTest {
    ...
    public void testRateChromosome() throws Exception {
        ...
        FitnessFunction calculator = new MusicalStatisticsFitness(new Harmony(Scale.MAJOR_SCALE.intervals(), NoteName.C), 2);

        calculator.calculateFitness(Arrays.asList(testChromosome));
        assertThat(testChromosome[0].getFitness().getFitnessValue(), is(1579));
