...
public class FitnessFunctionConfiguration {
    ...
    public static List<StatisticalFeatureModel> initStatisticConfiguration() {
        ...
        features.add(new StatisticalFeatureModel(StatisticName.PITCH_STANDARD_DEVIATION, 0.1, 200.0, 0.3, true));
        ...
        features.add(new StatisticalFeatureModel(StatisticName.RHYTHM_STANDARD_DEVIATION, 0.2, 200.0, 0.3, true));
